...
var DEFAULTS = {
    ...
    host:     "127.0.0.1",
    port:     6379,
    keyGen:   function (url) { return url; }
};
...
exports.middleware = function (options) {
    ...
    return function (req, res, next) {
        ...
        var urlKey = options.keyGen(url);
        cache.lruGet(urlKey, null, function (err, reply, key) {
            if (reply) {
            ...
            res.end = cacheResponse(res, res.end, urlKey, cache);
            next();
        });
    }
}